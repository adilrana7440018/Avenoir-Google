    ...
    <div className="min-h-screen mesh-bg py-10 md:py-16">
      <div className="max-w-7xl mx-auto px-6 space-y-10">
        ...
        <div className="flex items-center gap-2 text-xs text-text-secondary font-mono">
          ...
          <span>/</span>
          <span className="text-white uppercase">Search Results</span>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-text-secondary font-mono">
            QUERY: &ldquo;<span className="text-accent font-semibold">{query}</span>&rdquo; &bull; RESULTS: {products.length}
          </p>
        </div>
        ...
        {products.length === 0 ? (
          <div className="border border-dashed border-white/10 rounded-2xl p-16 flex flex-col items-center justify-center text-center space-y-4">
            <p className="text-white font-medium text-lg">No matches compiled</p>
            ...
            <Link
              href="/products/cases"
              className="px-5 py-2.5 bg-accent hover:bg-cyan-400 text-bg-primary font-bold rounded-xl text-xs transition-premium mt-2"
            >
              Browse Full Catalog
            </Link>
          </div>
